...
stoosRidge = Adventure.create!(user_id: user2.id, title:"Stoos Ridge Hike", address:"Stoosplatz 1, 6433 Stoos", description: "The Stoos Ridge Hike from Klingenstock to Fronalpstock offers a view of more than 10 lakes in Switzerland and countless Alpine peaks in Central Switzerland. Apart from the fascinating panoramic view, there is also a diversity of select alpine flowers to discover.  The route starts in the car-free village of Stoos at 1300 meters with a ride on the world’s steepest funicular – Schwyz/Schlattli-Stoos – or with the small Morschach-Stoos aerial cable car. After a brief hike through the small mountain village, ride the chairlift to the top of Klingenstock (operating times depend on season and weather). Naturally, the ascent can also be made on foot. The trail features a permanent 360º view, starting at Klingenstock via Rot Turm in the direction of Nollen. A mountain path meanders behind Huserstock and then down to Furggeli. Part of this path has been carved out of the rock and is secured with steel cables. Even though the entire trail is wide enough for two people to cross, hikers should be sure-footed and not afraid of heights. At the alpine hut in Furggeli there is a short, final ascent to the highest restaurant in the canton of Schwyz – on the peak of Fronalpstock.", category:"hiking trail", distance: 4, avg_duration: 120, stroller_friendly: false, youngest_age: 3, difficulty: 2, parking: true, public_transport: true, directions: "By train to Schwyz-Seewen station, then by bus to the valley station of the large Schwyz-Stoos cable car (line 1 Schwyz - Muotathal) or by train to SBB Brunnen station, then by bus to the valley station of the small Morschach-Stoos cable car.  If driving, take the A4 to the Schwyz exit, then follow the signs for Muotathal as far as the lower terminus of the large Schwyz-Stoos funicular railway; alternatively, turn onto Morschacherstrasse (at Wolfsprung), then follow the signs to Morschach and continue to the lower terminus of the small Morschach-Stoos aerial cableway.")
